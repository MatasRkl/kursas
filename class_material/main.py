from classes.db_class import DB
...
# db.add_data_model(model_id=4, Car_name='Audi', Mileag_km=228300, Model='A3')
# db.add_data_market(market_id= 3, Price= 2000, Make_year= 1999, Color='Red', Mileage_run= 156789, No_of_owners= 2)
